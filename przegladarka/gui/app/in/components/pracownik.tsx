...
import { dekretacja_id, dekretacje_na_pracownika, do_przetworzonych_in, zatwierdz_dekretacje_na_pracownika_lub_zwrot } from "../actions"
import { usePodpis } from "@/lib/podpis"
import { DekretacjaNaPracownika } from "./dekretacja"



export function NaPracownika({
  accounts = null,
  mails = null,
  defaultLayout = [30, 70],
  ...
  const [zrodlo, setZrodlo] = React.useState('Pracownik')
          ...
          <Tabs defaultValue="all">
            ...
            {(typListy === 'dokumenty') && <>
              <div className="flex items-center gap-2 px-0 py-2 border-b">
                ...
                <ActionsToolbar zrodlo={zrodlo} multi={true} isDecydent={isUzytkownikDecydent} zatwierdz={zatwierdz} odrzuc={do_przetworzonych_in} />
                <Separator orientation="vertical" className="mx-1 h-6" />
              </div>

              <TabsContent value="all" className="m-0">
                <DokumentList items={mails} onClick={rowClick} zrodlo={dekretacje_na_pracownika} guid={guid} query={query} />
              </TabsContent>
            </>}
