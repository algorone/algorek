...
import { dekretacja_id, dekretacje_na_wydzial, do_przetworzonych_in, zatwierdz_dekretacje_na_wydzial } from "../actions"
import { DekretacjaNaWydzial } from "./dekretacja"
...
export function Main({
  ...
  const [zrodlo, setZrodlo] = React.useState('Komorka')
          ...
          <Tabs defaultValue="all">
            ...
            {(typListy === 'dokumenty') && <>
              ...
              <TabsContent value="all" className="m-0">
                <DokumentList items={mails} onClick={rowClick} zrodlo={dekretacje_na_wydzial} guid={guid} query={query} />
              </TabsContent>
            </>}
        ...
        <ResizablePanel defaultSize={defaultLayout[1]}>
          ...
          <ViewCase warunek="dokumenty">
            {(guid != null) && <DokumentDisplay width={displayWidth} guidProvider={guid} >
              <>
                <DekretacjaNaWydzial dekretacja={dekretacja} />
                <Separator />
              </>
